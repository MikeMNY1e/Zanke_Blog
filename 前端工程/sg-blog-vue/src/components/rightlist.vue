    ...
    <section>
      <div class="r1-head">
        ...
        <h1 v-if="this.$store.state.themeObj.user_start != 0">
          <span style="font-weight: bold; color: darkred">今天又是一天</span>
          <span style="font-weight: bold; color: darkred">明天又是一天</span>
        </h1>
      </div>
      <div class="r1-body">
        <p>Zanke</p>
  ...
  data() {
    ...
    return {
      ...
      catchMeObj: {
        ...
        qq: "/static/img/wx_pay.png",
        sina: "https://weibo.com",
        wechat: "/static/img/wx_pay.png",
        csdn: "https://blog.csdn.net/2302_76151075?spm=1000.2115.3001.5343",
